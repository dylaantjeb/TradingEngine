...
────────────────────────────────
Candidate thresholds: [0.65, 0.70, 0.75].
...
# Narrowed to [0.65, 0.70, 0.75]: lower values (0.55, 0.60) select weak models
# and cause threshold instability across folds.
_THRESHOLD_CANDIDATES: list[float] = [0.65, 0.70, 0.75]
